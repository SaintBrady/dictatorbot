...
class Admin(commands.Cog):
    ...
    async def _chatmute(self, ctx: commands.Context, *, member: discord.Member):
    ...
    async def _chatunmute(self, ctx: commands.Context, *, member: discord.Member):
...
class Message(commands.Cog):
    ...
    async def refresh(self):
        ...
        await self.reset_phrases()
        contentFile = open("content.txt", "r")
        for line in contentFile:
            (key, val) = line.split(" : ")
            self.contentDict[key] = val

    async def reset_phrases(self):
